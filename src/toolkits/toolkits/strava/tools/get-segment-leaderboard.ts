...
export const getSegmentLeaderboardTool = createBaseTool({
  ...
  inputSchema: z.object({
    ...
    weight_class: z.enum(["0_124", "125_149", "150_164", "165_179", "180_199", "200_224", "225_plus"]).optional().describe("Filter by weight class in pounds"),
    following: z.boolean().optional().describe("Filter to just athletes the authenticated user is following"),
